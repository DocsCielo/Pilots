...
|--------|----------------------|------------------------------------------------------------------|
| 0      | **NotFinished**      | Transação que teve falha de comunicação com Skyline. Neste caso, a transação será sondada durante 48h ou até obter o retorno do Skyline.|
| 1      | **Authorized**       | Transação Autorizada|
| 2      | **PaymentConfirmed** | Transação Autorizada e Capturada|
| 3      | **Denied**           | Transação Negada|
| 10     | **Voided**           | Transação cancelada|
| 11     | **Refunded**         | Transação estornada|
| 13     | **Aborted**          | Transação rejeitada por COP ou por Antifraude. Neste caso, não terá o retorno do ReturnCode/ReturnMessage, pois a transação não foi gerada. |
