---
layout: manual
title: Google Pay integration spec using Braspag
...
Keep the values "_signedMessage_" and "_signature_". They will be requested in the Braspag's authorization process in the next step (Step 2: Authorization with Google Pay)
